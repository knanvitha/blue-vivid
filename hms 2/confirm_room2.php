...
<body>
	...
	<table style="width: 100%;">
		<tr>
			<td id="td1" style="padding: 10px; font-size: 48px;"><p style="color: #e6b800; font-size: 48px; display: inline;">BLUE</p> VIVID</td>
	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<p>Sorry! All rooms are full in this type.<br>Wait for the rooms to get empty.</p>
